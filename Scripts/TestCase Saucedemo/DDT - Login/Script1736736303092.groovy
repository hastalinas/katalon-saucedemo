...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/span_Products'), 5, FailureHandling.OPTIONAL)) {
	// Login berhasil
	WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/span_Products'), 'Products')
	println("Login berhasil!")
} else if (WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/h3_Epic sadface Username and password do not match any user in this service'), 5, FailureHandling.OPTIONAL)) {
	// Login gagal
	...
	println("Elemen tidak ditemukan, periksa kembali object test Anda!")
}
